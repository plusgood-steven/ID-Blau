...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir_path", default='./experiments/Stripformer_first_stage', type=str)
    parser.add_argument("--model_name", default='Stripformer_first_stage', type=str)
