...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir_path", default='./experiments/Stripformer_pretrained', type=str)
    parser.add_argument("--model_name", default='Stripformer_pretrained', type=str)
    ...
    assert args.generate_path and args.only_use_generate_data, "must use these setting"
