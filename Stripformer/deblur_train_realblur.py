...
from Stripformer.losses import get_loss
...
class Trainer():
    def __init__(self, dataloader_train, dataloader_val, model, optimizer, scheduler, args, writer) -> None:
        ...
        self.criterion = get_loss(args.criterion)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--criterion", default='Stripformer_Loss', type=str)
    ...
    parser.add_argument("--dir_path", default='./experiments/Stripformer_Realblur_J', type=str)
    parser.add_argument("--model_name", default='Stripformer_Realblur_J', type=str)
    ...
    if dist.get_rank() == 0:
        ...
        writer = SummaryWriter(os.path.join("Stripformer_log", args.model_name))
