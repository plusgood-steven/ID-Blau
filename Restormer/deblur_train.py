...
class Trainer():
    ...
    def set_train_dataloader(self):
        ...
        Train_set = Multi_GoPro_Loader(data_path=train_data_path, generate_path=self.args.generate_path, mode="train", crop_size=self.now_crop_size)
    ...
    def set_val_dataloader(self):
        # Val loader
        Val_set = Multi_GoPro_Loader(data_path=self.args.data_path, generate_path=self.args.generate_path, mode="test", crop_size=self.mini_crop_sizes[-1])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--end_epoch", default=5255, type=int)
    parser.add_argument("--start_epoch", default=1, type=int)
    parser.add_argument("--mini_epochs", default=[2800, 1220, 730, 275, 140, 90], type=int, nargs='+')
    parser.add_argument("--mini_batch_sizes", default=[8, 5, 4, 2, 1, 1], type=int, nargs='+')
    parser.add_argument("--mini_crop_sizes", default=[128, 160, 192, 256, 320, 384], type=int, nargs='+')
    parser.add_argument("--start_scheduler_epoch", default=2800, type=int)
    ...
    parser.add_argument("--dir_path", default='./experiments/Restormer', type=str)
