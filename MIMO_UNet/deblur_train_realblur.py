...
from dataloader import GoPro_RealBlur_Loader, RealBlur_Loader
...
if __name__ == "__main__":
    ...
    parser.add_argument("--GoPro_data_path", default='./dataset/GOPRO_Large', type= str)
    parser.add_argument("--RealBlur_data_path", default='./dataset/Realblur_J', type= str)
    parser.add_argument("--dir_path", default='./experiments/MIMO_UNetPlus_Realblur_J_GOPRO', type=str)
    parser.add_argument("--model_name", default='MIMO_UNetPlus_Realblur_J_GOPRO', type=str)
    ...
    if args.optimizer == "adam":
        ...
        optimizer = optim.AdamW(net.parameters(), lr=args.init_lr, weight_decay=1e-3, betas=[0.9, 0.9])
    else:
    ...
    # Traning loader
    if args.GoPro_data_path and args.GoPro_data_path != 'None':
        Train_set = GoPro_RealBlur_Loader(GoPro_data_path=args.GoPro_data_path, Realblur_data_path=args.RealBlur_data_path, mode="train", crop_size=args.crop_size, ZeroToOne=False)
    else:
        Train_set = RealBlur_Loader(data_path=args.RealBlur_data_path, mode="train", crop_size=args.crop_size, ZeroToOne=False)
    ...
    # Val loader
    Val_set = RealBlur_Loader(data_path=args.RealBlur_data_path, mode="test", crop_size=args.crop_size, ZeroToOne=False)
