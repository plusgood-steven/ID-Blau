...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir_path", default='./experiments/MIMO_UNetPlus_pretrained', type=str)
    parser.add_argument("--model_name", default='MIMO_UNetPlus_pretrained', type=str)
